...
router.get("/users", _auth2.default.GetAllUsers);
router.delete("/admin/users/:userId", _jwt.verifyAccessToken, _auth2.default.deleteUser);
router.put("/admin/users/:userId/role", _jwt.verifyAccessToken, _auth2.default.changeUserRole);
